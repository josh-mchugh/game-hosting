...
public class ProjectCreateControllerServerTest {
    ...
    public void whenRequestIsAnonymousThenExpectRedirect() throws Exception {
        ...
        MockHttpServletRequestBuilder request = MockMvcRequestBuilders.get("/project/1/create/server")
    ...
    public void whenPostHasErrorsThenExpectRedirect() throws Exception {
        ...
        MockHttpServletRequestBuilder request = MockMvcRequestBuilders.post("/project/1/create/server")
                .with(SecurityMockMvcRequestPostProcessors.user("user"))
                .with(SecurityMockMvcRequestPostProcessors.csrf());

        this.mockMvc.perform(request)
                .andDo(MockMvcResultHandlers.log())
                .andExpect(MockMvcResultMatchers.redirectedUrl("/project/1/create/server"));
    }
    ...
    public void whenPostIsValidThenExpectRedirect() throws Exception {
        ...
        this.mockMvc.perform(request)
                .andDo(MockMvcResultHandlers.log())
                .andExpect(MockMvcResultMatchers.redirectedUrl("/project/1/create/billing"));
    }
}
