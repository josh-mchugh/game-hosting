...
public class ProjectCreateProjectionServiceFetchImageIdTest {
    ...
    public void whenParamIsNullThenThrowException() {
        ...
        Assertions.assertThrows(UndeclaredThrowableException.class, () -> service.fetchProjectImageId(null));
    }
    ...
    public void whenParamHasNullIdThenThrowException() {
        ...
        Assertions.assertThrows(UndeclaredThrowableException.class, () -> service.fetchProjectImageId(query));
    }
