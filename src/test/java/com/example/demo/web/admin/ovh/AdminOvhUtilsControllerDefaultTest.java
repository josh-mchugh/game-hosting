...
public class AdminOvhUtilsControllerDefaultTest {
    ...
    public void whenUserIsUnauthorizedThenExpectLoginScreen() throws Exception {
        ...
        MockHttpServletRequestBuilder request = MockMvcRequestBuilders.get("/admin/ovh-utils");
    ...
    public void whenUrlIsValidThenExpectTemplate() throws Exception {
        ...
        this.mockMvc.perform(request)
                .andDo(MockMvcResultHandlers.log())
                .andExpect(MockMvcResultMatchers.view().name("admin/ovh/view-default"));
    }
}
