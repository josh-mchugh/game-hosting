...
public class AdminGameServerProjectorControllerGetDefaultTest {
    ...
    public void whenUserIsUnauthorizedThenExpectLoginScreen() throws Exception {
        ...
        MockHttpServletRequestBuilder request = MockMvcRequestBuilders.get("/admin/game-servers");
    ...
    public void whenUserIsAdminThenReturnView() throws Exception {
        ...
        this.mockMvc.perform(request)
                .andDo(MockMvcResultHandlers.log())
                .andExpect(MockMvcResultMatchers.view().name("admin/game/view-default"));
    }
}
